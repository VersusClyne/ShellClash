...
#Synology版本-github直连
sh -c "$(curl -kfsSl --resolve raw.githubusercontent.com:443:199.232.68.133 https://raw.githubusercontent.com/VersusClyne/ShellClash/sysnology-router-manager/install.sh)" && source /etc/profile &> /dev/null
```
